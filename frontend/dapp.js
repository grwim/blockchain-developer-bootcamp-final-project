...
const factoryAddress = '0xF4Ae80EADd943651D28BB426759Fb09915D59A74'
      ...
      "inputs": [
        {
          "indexed": false,
          "internalType": "uint256",
          "name": "amount_rainfall",
          "type": "uint256"
        }
      ],
      "name": "contractRainfall",
      "type": "event"
    },
    {
      "stateMutability": "payable",
...
cc_Submit.onclick = async () => {
  ...
  return_obj = await InsuranceFactory.methods.createContract(ccClient, ccDuration, ccPremium, ccPayout, ccLocation).send({from: ethereum.selectedAddress})
